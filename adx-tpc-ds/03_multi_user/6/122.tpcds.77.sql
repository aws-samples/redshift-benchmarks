...
:EXPLAIN
-- start query 22 in stream 5 using template query77.tpl and seed 944473911
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7519-10-18' as date) 
                  and (cast('7519-10-18' as date) +  '30 days'::interval ) 
