...
:EXPLAIN
-- start query 49 in stream 17 using template query66.tpl and seed 233294133
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 48682 and 48682+28800 
 	and sm_carrier in ('TBS','USPS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
