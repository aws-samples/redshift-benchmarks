...
:EXPLAIN
-- start query 37 in stream 17 using template query77.tpl and seed 894027519
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('4754-01-03' as date) 
                  and (cast('4754-01-03' as date) +  '30 days'::interval ) 
