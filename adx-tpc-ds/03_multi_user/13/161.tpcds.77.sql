...
:EXPLAIN
-- start query 61 in stream 12 using template query77.tpl and seed 1523273151
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('6211-01-09' as date) 
                  and (cast('6211-01-09' as date) +  '30 days'::interval ) 
