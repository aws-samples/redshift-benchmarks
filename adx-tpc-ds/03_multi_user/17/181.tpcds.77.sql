...
:EXPLAIN
-- start query 81 in stream 16 using template query77.tpl and seed 574603293
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7067-10-10' as date) 
                  and (cast('7067-10-10' as date) +  '30 days'::interval ) 
