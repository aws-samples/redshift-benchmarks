...
:EXPLAIN
-- start query 42 in stream 11 using template query77.tpl and seed 573837171
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7026-10-29' as date) 
                  and (cast('7026-10-29' as date) +  '30 days'::interval ) 
