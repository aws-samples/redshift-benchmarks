...
:EXPLAIN
-- start query 36 in stream 10 using template query28.tpl and seed 1332892004
select  *
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 9 and 9+10
          or ss_coupon_amt between 4505 and 4505+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 56 and 56+10
          or ss_coupon_amt between 20 and 20+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 129 and 129+10
          or ss_coupon_amt between 15107 and 15107+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 14457 and 14457+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 2 and 2+10
          or ss_coupon_amt between 4972 and 4972+1000
