...
:EXPLAIN
-- start query 47 in stream 10 using template query77.tpl and seed 1664034803
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7321-04-29' as date) 
                  and (cast('7321-04-29' as date) +  '30 days'::interval ) 
