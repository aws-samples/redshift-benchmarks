...
:EXPLAIN
-- start query 55 in stream 6 using template query77.tpl and seed 1812200392
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2231-04-11' as date) 
                  and (cast('2231-04-11' as date) +  '30 days'::interval ) 
