...
:EXPLAIN
-- start query 35 in stream 9 using template query77.tpl and seed 723820844
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2036-06-19' as date) 
                  and (cast('2036-06-19' as date) +  '30 days'::interval ) 
