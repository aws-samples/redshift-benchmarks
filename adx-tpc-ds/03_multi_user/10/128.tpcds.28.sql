...
:EXPLAIN
-- start query 28 in stream 9 using template query28.tpl and seed 631110307
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 55 and 55+10 
             or ss_coupon_amt between 651 and 651+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 176 and 176+10
          or ss_coupon_amt between 16756 and 16756+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 94 and 94+10
          or ss_coupon_amt between 974 and 974+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 45 and 45+10
          or ss_coupon_amt between 6241 and 6241+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 8048 and 8048+1000
