...
:EXPLAIN
-- start query 67 in stream 8 using template query77.tpl and seed 564241670
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('6497-04-12' as date) 
                  and (cast('6497-04-12' as date) +  '30 days'::interval ) 
