...
:EXPLAIN
-- start query 33 in stream 4 using template query77.tpl and seed 1915715750
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7901-08-24' as date) 
                  and (cast('7901-08-24' as date) +  '30 days'::interval ) 
