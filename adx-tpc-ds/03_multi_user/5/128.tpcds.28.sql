...
:EXPLAIN
-- start query 28 in stream 4 using template query28.tpl and seed 219464614
select  *
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 146 and 146+10 
             or ss_coupon_amt between 15747 and 15747+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 154 and 154+10
          or ss_coupon_amt between 5827 and 5827+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 43 and 43+10
          or ss_coupon_amt between 8894 and 8894+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 53 and 53+10
          or ss_coupon_amt between 718 and 718+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 108 and 108+10
          or ss_coupon_amt between 5213 and 5213+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 190 and 190+10
          or ss_coupon_amt between 4204 and 4204+1000
