...
:EXPLAIN
-- start query 26 in stream 2 using template query77.tpl and seed 2137996503
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('6870-06-06' as date) 
                  and (cast('6870-06-06' as date) +  '30 days'::interval ) 
