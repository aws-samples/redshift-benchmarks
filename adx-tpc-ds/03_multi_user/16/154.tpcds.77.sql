...
:EXPLAIN
-- start query 54 in stream 15 using template query77.tpl and seed 1002931402
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('4116-08-30' as date) 
                  and (cast('4116-08-30' as date) +  '30 days'::interval ) 
