...
:EXPLAIN
-- start query 50 in stream 19 using template query77.tpl and seed 1664834479
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('7362-02-07' as date) 
                  and (cast('7362-02-07' as date) +  '30 days'::interval ) 
