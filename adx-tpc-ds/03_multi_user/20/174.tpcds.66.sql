...
:EXPLAIN
-- start query 74 in stream 19 using template query66.tpl and seed 1123479711
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 15715 and 15715+28800 
 	and sm_carrier in ('TBS','DIAMOND')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
