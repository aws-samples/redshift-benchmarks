...
:EXPLAIN
-- start query 28 in stream 19 using template query28.tpl and seed 1496210257
select  *
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 68 and 68+10
          or ss_coupon_amt between 6193 and 6193+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 35 and 35+10
          or ss_coupon_amt between 6707 and 6707+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 127 and 127+10
          or ss_coupon_amt between 6519 and 6519+1000
