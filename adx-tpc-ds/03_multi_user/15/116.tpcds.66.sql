...
:EXPLAIN
-- start query 16 in stream 14 using template query66.tpl and seed 1630832484
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 11522 and 11522+28800 
 	and sm_carrier in ('USPS','ZOUROS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
