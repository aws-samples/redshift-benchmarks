...
:EXPLAIN
-- start query 38 in stream 14 using template query77.tpl and seed 1127866009
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('4357-10-29' as date) 
                  and (cast('4357-10-29' as date) +  '30 days'::interval ) 
