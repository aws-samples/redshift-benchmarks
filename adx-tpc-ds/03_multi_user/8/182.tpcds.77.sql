...
:EXPLAIN
-- start query 82 in stream 7 using template query77.tpl and seed 269397065
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('3550-09-30' as date) 
                  and (cast('3550-09-30' as date) +  '30 days'::interval ) 
