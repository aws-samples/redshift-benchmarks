...
:EXPLAIN
-- start query 10 in stream 1 using template query77.tpl and seed 1201818253
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('8410-08-11' as date) 
                  and (cast('8410-08-11' as date) +  '30 days'::interval ) 
