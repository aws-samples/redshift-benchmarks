...
:EXPLAIN
-- start query 97 in stream 13 using template query77.tpl and seed 383034079
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('3172-12-15' as date) 
                  and (cast('3172-12-15' as date) +  '30 days'::interval ) 
