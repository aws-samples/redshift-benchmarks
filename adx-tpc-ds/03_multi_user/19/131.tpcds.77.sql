...
:EXPLAIN
-- start query 31 in stream 18 using template query77.tpl and seed 1590807879
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('3310-04-22' as date) 
                  and (cast('3310-04-22' as date) +  '30 days'::interval ) 
