...
:EXPLAIN
-- start query 32 in stream 3 using template query66.tpl and seed 248315888
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'ORIENTAL' || ',' || 'FEDEX' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 46160 and 46160+28800 
 	and sm_carrier in ('ORIENTAL','FEDEX')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
