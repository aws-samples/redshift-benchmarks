...
:EXPLAIN
-- start query 85 in stream 3 using template query77.tpl and seed 451036916
with ss as
 (select s_store_sk,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('6899-08-23' as date) 
                  and (cast('6899-08-23' as date) +  '30 days'::interval ) 
