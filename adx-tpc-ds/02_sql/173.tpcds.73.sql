...
:EXPLAIN
-- start query 79 in stream 0 using template query73.tpl and seed 119993300
select c_last_name
       ,c_first_name
       ,c_salutation
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Kittitas County','Bronx County','Barrow County','Jackson County')
